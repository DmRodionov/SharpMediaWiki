...
You will need "Microsoft .NET Framework 4.6":https://www.microsoft.com/en-us/download/details.aspx?id=48137 to compile and use the library on Windows. It can be also compiled with "Mono 2.4":http://mono-project.com/Main_Page (at least "MoMA":http://www.mono-project.com/MoMA didn't report any problems).
